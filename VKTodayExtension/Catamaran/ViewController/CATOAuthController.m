...
{
    BOOL shouldStart = NO;
    if ([request.URL.absoluteString rangeOfString:@"redirect_uri="].location != NSNotFound)
    {
        shouldStart = YES;
    }
    else if([request.URL.host isEqualToString:self.socialOAuth.redirectURI.host])
    {
